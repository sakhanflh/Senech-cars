...
export default function LoginMobilePage(){
    return(
        <>
        <div className="w-full h-dvh flex items-end text-dark">
            <div className=" w-full bg-white overflow-hidden rounded-t-xl h-[28rem] justify-between flex flex-col">
                ...
                <div className=" px-5 pb-5 h-[60%] border-t flex flex-col justify-around">
                    ...
                    <div className="flex flex-col w-full h-20 justify-around">
                        <input type="email" placeholder="Email" className="py-1 rounded-md border border-black"/>
                        <input type="password" placeholder="Password" className="py-1 rounded-md border border-black"/>
                    </div>
                    <p className="w-full justify-end flex text-secondary">Forgot your password?</p>
                    <button className="bg-tertiary p-3 rounded-md">Login</button>
                </div>
            </div>
        </div>
        </>
