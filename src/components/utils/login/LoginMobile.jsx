...
export default function LoginMobilePage({onShowLogin}){
    return(
        <>
        <div className={onShowLogin ? "w-full h-[28rem] translate-y-0 flex items-end absolute text-dark left-0 top-[23rem] transition-all duration-500" : "left-0 top-[23rem] w-full h-[28rem] translate-y-full transition-all duration-500 items-end bg-green-500 absolute text-dark"}>
